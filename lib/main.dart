// ╔══════════════════════════════════════════════════════════════╗
// ║  DOMÓTICA PRO  v3.1  —  Celular: /flash/on y /flash/off     ║
// ║  Solo IP y puerto, sin escribir rutas manuales              ║
// ╚══════════════════════════════════════════════════════════════╝
...
// ═══════════════════════════════════════════════════════════════
// CONTROL DE RED (RUTAS ACTUALIZADAS PARA CELULAR)
// ═══════════════════════════════════════════════════════════════
class NetCtrl {
  ...
  static String _rutaOff(TipoD t) => const {
    ...
    TipoD.celular: '/flash/off',   // ← CAMBIADO
    TipoD.otro   : '/off',
  }[t]!;
...
// ═══════════════════════════════════════════════════════════════
// REPOSITORIO Y NOTIFIER (sin cambios)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// DASHBOARD y resto de widgets (sin cambios, se incluyen completos)
// ═══════════════════════════════════════════════════════════════
// (Todo el código de DashboardPage, HabitacionesPage, DispositivosPage,
// HistorialPage y sus subwidgets es el mismo que en la versión anterior.
// Por brevedad no lo repito aquí, pero puedes integrarlo desde el código
// que ya tenías funcionando. El único cambio crítico está en NetCtrl.)

// NOTA: Si necesitas el resto de páginas (Dashboard, Habitaciones, Dispositivos,
// Historial) ya las tienes en tu proyecto. Simplemente asegúrate de que estén
// completas. Si falta algo, avísame y te paso el archivo íntegro.
